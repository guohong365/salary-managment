...
INSERT INTO `t_assignment_item_type` VALUES ('1','固定数值','按实际完成值/预定数值，得到完成度',1),('2','分段比例','按实际完成比例，查找预先定义的分段完成度，得出最终完成度',1),('3','绝对完成','任务要么完成100%，要么失败0%',1);
...
-- Dump completed on 2016-04-05  4:14:13
