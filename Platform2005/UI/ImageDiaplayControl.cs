namespace Platform.UI
{
    ...
    public class ImageDiaplayControl : UserControl
    {
        ...
        public ImageDiaplayControl(ArrayList imageList)
        {
        ...
        public ImageDiaplayControl(DataTable dt, string imageDataColumnName)
        {
            this.cc = new PictureBoxControl();
            this.m_ImageList = new ArrayList();
            this.InitializeComponent();
        ...
        public ImageDiaplayControl(DataSet ds, string tableName, string imageDataColumnName)
            : this(ds.Tables.Contains(tableName) ? ds.Tables[tableName] : null, imageDataColumnName)
        {
        }
        ...
        private void ImageDiaplayControl_Load(object sender, EventArgs e)
        {
        ...
        private void InitializeComponent()
        {
            ...
            base.Name = "ImageDiaplayControl";
            base.Size = new Size(0x27a, 0x1ca);
            base.Load += new EventHandler(this.ImageDiaplayControl_Load);
