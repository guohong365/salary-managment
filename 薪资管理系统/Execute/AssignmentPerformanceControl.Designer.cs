namespace SalarySystem.Execute
{
    partial class AssignmentPerformanceControl
    {
      ...
      this.colCOMISSION_BASE = new DevExpress.XtraGrid.Columns.GridColumn();
      ...
      this.colDEFINE_UNIT.VisibleIndex = 5;
      // 
      ...
      // colCOMISSION_BASE
      // 
      this.colCOMISSION_BASE.Caption = "提成基数";
      this.colCOMISSION_BASE.Name = "colCOMISSION_BASE";
      this.colCOMISSION_BASE.Visible = true;
      this.colCOMISSION_BASE.VisibleIndex = 4;
      // 
      ...
      this.ResumeLayout(false);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colCOMISSION_BASE;
    }
}
